...
let listDayhAvailability: ListDayAvailabilityService;

describe('ListDayAvailability', () => {
  beforeEach(() => {
    fakeAppointmentsRepository = new FakeAppointmentsRepository();
    listDayhAvailability = new ListDayAvailabilityService(
  ...
  it('should be able to list the day availability from providers', async () => {
    ...
    const availability = await listDayhAvailability.execute({
      provider_id: 'user',
      year: 2020,
      month: 5,
      day: 20,
